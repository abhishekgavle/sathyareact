...
function Bakery() {
  ...
  const filteredItems = bakeryItems.filter(
    (item) =>
  ...
  return (
    <div className="container my-4">
      <div className="bg-info text-dark text-center py-3 rounded shadow-sm">
        <h3 className="mb-0">🥐 Welcome to the Bakery Section 🍰</h3>
        <p className="mb-0">Fresh and delightful bakery items!</p>
      </div>
      ...
      <div className="d-flex justify-content-center mt-4">
        ...
        {Array.from({ length: totalPages }, (_, index) => (
          <button
            key={index}
            className={`btn ${index === pageNumber ? "btn-info" : "btn-outline-info"} mx-1`}
