  ...
  return (
    <div className="container my-4">
      <div className="bg-warning text-dark text-center py-3 rounded shadow-sm">
        <h3 className="mb-0">🥨 Welcome to the Snack Section 🧁</h3>
        <p className="mb-0">Delicious snacks for every craving!</p>
      </div>
      ...
      <div className="d-flex justify-content-center mt-4">
        ...
        {Array.from({ length: totalPages }, (_, index) => (
          <button
            key={index}
            className={`btn ${index === pageNumber ? "btn-warning" : "btn-outline-warning"} mx-1`}
